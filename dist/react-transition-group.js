(function (global, factory) {
  ...
  */
  ...
  var transitionGroupContextPropType = undefined({
    isMounting: propTypes_4.isRequired
  });
  function withTransitionGroup(ComponentToWrap) {
    return mapContextToProps(Consumer, function (value) {
      return {
  ...
  function (_React$Component) {
    ...
    function Transition(props) {
      ...
      var parentGroup = props.transitionGroup; // In the context of a TransitionGroup all enters are really appears
    ...
    _proto.performEnter = function performEnter(node, mounting) {
      ...
      var appearing = this.props.transitionGroup ? this.props.transitionGroup.isMounting : mounting;
    ...
    return Transition;
  }(React__default.Component); // Name the function so it is clearer in the documentation


  function noop() {}

  var TransitionWithContext = withTransitionGroup(polyfill(Transition));
  ...
  Transition.propTypes = _extends({}, TransitionWithContext.propTypes, {
  ...
  function (_React$Component) {
    ...
    _proto.render = function render() {
      ...
      return React__default.createElement(TransitionWithContext, _extends({}, props, {
  ...
  CSSTransition.propTypes = _extends({}, TransitionWithContext.propTypes, {
    /**
  ...
  exports.Transition = TransitionWithContext;
